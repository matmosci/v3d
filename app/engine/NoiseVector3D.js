...
export default class NoiseVector3D {
    constructor(scaleFactor = 1) {
        ...
        this.z = new perlinNoise3d();
        this.scaleFactor = scaleFactor;
    }
    get(x, y, z) {
        return {
            x: this.x.get(x / this.scaleFactor, y / this.scaleFactor, z / this.scaleFactor) - Math.sqrt(0.22),
            y: this.y.get(x / this.scaleFactor, y / this.scaleFactor, z / this.scaleFactor) - Math.sqrt(0.22),
            z: this.z.get(x / this.scaleFactor, y / this.scaleFactor, z / this.scaleFactor) - Math.sqrt(0.22),
        };
    }
}
